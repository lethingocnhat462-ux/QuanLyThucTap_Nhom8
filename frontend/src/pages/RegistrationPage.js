...
const RegistrationPage = () => {
   ...
   const handleRegister = async () => {
    ...
    const renderOptions = (currentValue, otherValues) => {
        ...
        return (
            <>
                <option value="">{t("-- Chọn trường thực tập --")}</option>
                {danhSachTruong.map((truong) => {
                    ...
                    return (
                        ...
                        >
                            {truong.TenDonVi} {isSelectedElsewhere ? t("(Đã chọn)") : ""}
                        </option>
                    );
                })}
            </>
                ...
                <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-blue-100 overflow-hidden transition-all duration-500 hover:shadow-[0_30px_60px_rgba(37,99,235,0.1)]">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h2 className="text-2xl font-black uppercase tracking-tight">
                                    {t("Đăng ký")} <span className="text-blue-200">{t("Nguyện vọng")}</span>
                                </h2>
                                <p className="text-blue-100/80 text-xs font-mono tracking-widest mt-1 uppercase">
                                    {t("Hệ thống điều phối thực tập v8.0")}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="p-10 space-y-8 bg-white">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <label className="text-[13px] font-bold text-slate-700 uppercase tracking-wider">
                                    {t("Nguyện vọng 1 (Ưu tiên cao nhất) *")}
                                </label>
                            </div>
                            <select 
                        ...
                        <div className="space-y-3">
                            ...
                            <textarea 
                                ...
                                placeholder={t("Ví dụ: Mong muốn thực tập tại khu vực gần nơi cư trú...")} 
                        ...
                        <div className="flex justify-center pt-6">
                            ...
                            >
                                <span className="relative z-10">{t("XÁC NHẬN ĐĂNG KÝ HỆ THỐNG")}</span>
                    ...
                    <div className="bg-slate-50 border-t border-slate-100 p-6 text-center">
                        <p className="text-[10px] text-slate-400 font-mono uppercase tracking-[0.3em]">
                            {t("Mọi thông tin sẽ được tự động đồng bộ hóa với cơ sở dữ liệu khoa sư phạm")}
                        </p>
                    </div>
                </div>
            </div>
